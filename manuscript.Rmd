...
Respectively, in the current paper it is assumed that there may be a disconnect between the overall number of sampled outcomes and the size of the samples the mind relies on in the evaluation of prospects.
