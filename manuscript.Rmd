...
To obtain useful descriptions of the properties of interest, it is rather required to make inferences from incomplete or noisy inputs, and the feasibility and ease of these inferences is partly determined by how the inputs are represented. 


<!-- The way shape information is organized by a representation. Different information/properties require different organizations of the inputs ... some information may be costly to obtain in a certain representaion ...    -->
