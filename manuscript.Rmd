...
In natural world decisions, however, the relevant properties of choice alternatives are often distal and amenable only through a *sample* which, by definition, cannot provide complete information.
Such a sample requires the mind to make an inductive inference, leading to a description which, according to the law of large numbers [cf., e.g., @georgiiStochastikEinfuhrungWahrscheinlichkeitstheorie2015, Chapter 5.1], is only probable in proportion to the size of the (representative) sample [but see @fiedlerInformationSamplingAdaptive2006, for a selection of papers which goes beyond the mere discussion of statistically representative samples]. 

To express the idea that the tuple of a prospect is not given

As for prospects, a sample is  sample has a well defined meaning
