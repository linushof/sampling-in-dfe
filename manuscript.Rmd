...
@regenwetterConstructbehaviorGapBehavioral2017 show that ... For example, aggregate data may ignore potential individual differences and heterogeneity within people, which may be permitted by a theory.
Also, aggregating across choice problems and using the frequent vs. infrequent switchers render confuses process vs. individual trait.
Moreover, sampling error and the undersampling of small-probability outcomes is only accounted for to the extent that choice trials in which small-probability outcomes were not sampled are excluded.
This does not control for systematic distortions.

4. *Narrow scope of analysis:*
[...]

<!-- Outline -->
The current paper aims to address the outlined problems.
