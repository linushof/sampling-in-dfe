...
In this case, people make decisions under risks, given that choosing one of the prospects does not inevitably lead to a certain outcome.
...
The current paper presents a model that aims to sketch how the mind might exercise the capacity of making decisions from experience and shows how such a model comes to imply an as-if underweighting of rare outcomes pattern.
...
-->
Therefore, consider first what @hillsInformationSearchDecisions2010 consider the finding that in DFE *sampling strategies* were indicative for the final choice.
