...
To substantiate the discussion and obtain the actual predictions of the models, computational implementations thereof were used to simulate the sampling and accumulation process for a set of choices between a safe prospect and a two-outcome (risky) prospect.
...
The simulated choices and estimated CPT parameters can be roughly understood as theory-implied data and data models, which remain to be tested against empirical data.
