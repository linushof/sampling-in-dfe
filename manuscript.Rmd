...
Yet, it follows that the underweighting pattern that is caused by the adoption of an arbitrary selection criterion is a priori predicted to become more stable with increasing sample size. 
...
# Selection Criteria / Properties of Choice Alternatives / Sampling
...
<!-- Of course, the whole argument rests on the assumption that ... -->

## What are the properties of choice alternatives and the selection criteria? 

This paper refrains from making inroads into the questions of whether and why *prospects* are useful abstractions of the choice alternatives the mind is required to evaluate in natural world decisions.
It just considers choices between at least two prospects because they are the standard paradigm in research on decision theory and they suffice 
