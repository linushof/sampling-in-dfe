...
In sum, to understand whether and how sampling and decision strategies act together to shape DFE, one should not only explicitly model their links, but also consider their interplay more broadly and systematically.

3. *Use of heuristic analysis methods:*
[...]
For reasons that can be found in Regenwetter and Robinson's [-@regenwetterConstructbehaviorGapBehavioral2017] rigorous work, 

4. *Narrow scope of analysis:*

<!-- Outline -->
The current paper aims to address the outlined problems and thereby to extend and improve the work of Hills and Hertwig [@hillsInformationSearchDecisions2010].
