...
Such frameworks build on different, sometimes related or complementary assumptions, e.g.: *ecological rationality* holds that the mind uses simple (decision) heuristics that exploit the information structures of the environment in which it operates [see, e.g., @payneAdaptiveStrategySelection1988; see also @simonRationalChoiceStructure1956]; sequential sampling models assume that the mind trades of processing speed and accuracy while accumulating evidence for or against choice alternatives [see, e.g., @ratcliffComparisonSequentialSampling2004; @bogaczPhysicsOptimalDecision2006]; and *resource rationality* assumes that the mind employs mechanisms that make optimal use of its actual resources in obtaining a specific goal [see, e.g.; @liederResourcerationalAnalysisUnderstanding2020].
...
<!-- Marr: What is the goal and how can it be achieved -->

<!-- Using CPT as effects -->
