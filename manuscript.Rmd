...
Since in round-wise decisions small-probability outcomes are predicted not to be considered in the majority of comparisons, such a coupling could indeed explain an as-if underweighting of rare events (see also Fig.\ \@ref(fig:sampling-paradigm), for illustrative purposes).


Pointing to such a coupling of sampling and decision strategies, they found that a larger proportion choices of people who, on average, switched infrequently between prospects during the sampling phase were better predicted by a summary strategy (rather than a round-wise strategy), and that this predictive pattern reversed for people who switched frequently [but see @wulffHowShortLongrun2015].
...
In the first section, it is briefly discussed 
