...
Consistent with this statistical regularity, sequential sampling models of decision making [e.g., @bhatiaSequentialSamplingParadoxes2014; @busemeyerDecisionFieldTheory1993; @markantModelingChoiceSearch2015; @ratcliffComparisonSequentialSampling2004] assume that the information-processing chain upfront choices in DfE takes the form of an evidence accumulation process over time, with choices becoming more accurate the more evidence must be accumulated.
Specifically, in one paradigm used to study DfE, namely, the sampling paradigm [@weberPredictingRiskSensitivity2004], before making a choice between prospects with latent properties, people can, as much as they want, sequentially sample the prospects' outcomes according to their objective probabilities.
To relate the sampling process to the choice, sequential sampling models assume that the sampled outcomes are sequentially accumulated into one or more dynamic decision variables, and that a choice is made once a decision variable exceeds a threshold in favor for one of the prospects.
Accordingly, the number of outcomes required to sample decreases with thresholds, which could account for an as-if underweighting of rare outcomes [see @markantModelingChoiceSearch2015].
